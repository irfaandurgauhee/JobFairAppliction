...
import ch.elca.academy.leaveMngSys.entity.Employee;
import com.elca.jobfairmanagementsystem.entity.Employee;
...
public class JwtTokenUtil implements Serializable {
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        final String visa = getUsernameFromToken(token);
        return (
                visa.equals(userDetails.getUsername())
